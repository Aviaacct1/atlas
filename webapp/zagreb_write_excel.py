...
# reached over the service or run by hand. No override flag exists on purpose; clearing
# happens in config/export_watchpoints.yaml, deliberately and auditably.
